...
- (UIImage *)lm_applyLightEffect
{
    ...
    return [self lm_applyBlurWithRadius:30 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)lm_applyExtraLightEffect
{
    ...
    return [self lm_applyBlurWithRadius:20 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)lm_applyTintEffectWithColor:(UIColor *)tintColor
{
    ...
    return [self lm_applyBlurWithRadius:10 tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
